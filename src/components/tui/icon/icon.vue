<template>
	<view class="tui-icon-class tui-icon" :class="'tui-icon-'+name" :style="{ color: color, fontSize: $mUtils.px(size) ,fontWeight:bold?'bold':'normal'}"
...
<style>
	...
	.tui-icon.tui-icon-turningdown, .tui-icon.tui-icon-turningup{
		line-height: 12upx;
	}
