	...
	<view class="navigation">
		<view class="left">
			<view class="item" @click="callBoss">
				<u-icon name="../../static/imgs/index/message.png" :size="40" :color="$u.color['contentColor']">
				</u-icon>
			...
			<view class="item car" @tap="cart()">
				<u-icon name="../../static/imgs/index/cart.png" :size="40" :color="$u.color['contentColor']"></u-icon>
				<view class="text u-line-1">购物车</view>
			</view>
		</view>
		<view class="right">
			<view class="buy-now" @click="addCart">加入购物车</view>
			<view class="addCart" @click="openPop">立即购买</view>
		</view>
		<view>
			<u-popup v-model="show" mode="bottom" border-radius="14">
				<view class="container">
					...
					<view class="footer">
						<view class="comfirmBtn" @click="toAddCart" v-if="isCart">加入购物车</view>
						<view class="comfirmBtn" @click="toCheckOrder" v-else>确认</view>
					</view>
				</view>
			</u-popup>
		</view>
...
<style lang="scss" scoped>
	.navigation {
		...
		.right {
			...
			.buy-now {
				background-image: url("../../static/imgs/index/button-left.png");
				width: 190rpx;
				height: 78rpx;
			...
			.addCart {
				background-image: url("../../static/imgs/index/button-right.png");
				width: 190rpx;
				height: 78rpx;
				background-repeat: no-repeat;
				background-size: 100% 100%;
