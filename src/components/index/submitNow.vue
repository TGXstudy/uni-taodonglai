<template>
	<view class="navigation">
		<view class="left">
			...
			<!-- <view class="item">
				<u-icon name="../../static/imgs/index/favor.png" :size="40" :color="$u.color['contentColor']"></u-icon>
...
<script>
	export default {
		...
		computed: {
			price() {
				if (this.currentGoods) {
					return `￥${this.currentGoods.sec_buy_price}`
				}
...
<style lang="scss" scoped>
	.navigation {
		...
		.right {
			...
			.buy-now {
				background-image: url("../../static/imgs/index/sub-btn.png");
				width: 548rpx;
				height: 78rpx;
