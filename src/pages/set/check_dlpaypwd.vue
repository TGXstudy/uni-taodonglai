	...
	<view class="grzl">
		...
		<view class="two">
			<view class="tx">
				...
				<view class="right">
					<input v-model="pwd" password placeholder="请输入6-16位数字或字母密码" type="number" value="" />
				</view>
			</view>
			<view class="tx">
				<view class="left">
				...
				<view class="right">
					<input v-model="check_pwd" password placeholder="请输入6位数字或字母密码" type="number" value="" />
				</view>
			</view>
